...
RSpec.describe Stannum::Constraints::Parameters::ExtraKeywords do
      ...
      describe 'with a hash with extra keys' do
        ...
        let(:expected_messages) do
          expected_errors.map do |err|
            err.merge(message: 'has extra keywords')
          end
        end
  ...
  describe '#negated_match' do
    ...
    let(:expected_messages) do
      expected_errors.merge(message: 'does not have extra keywords')
    end
