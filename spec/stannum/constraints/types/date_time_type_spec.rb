...
require 'stannum/constraints/types/date_time_type'

require 'support/examples/constraint_examples'

RSpec.describe Stannum::Constraints::Types::DateTimeType do
  include Spec::Support::Examples::ConstraintExamples

  subject(:constraint) { described_class.new(**constructor_options) }

  let(:constructor_options) { {} }
  let(:expected_options)    { { expected_type: DateTime, required: true } }
  ...
  describe '#expected_type' do
    include_examples 'should have reader', :expected_type, DateTime
  end
  ...
  describe '#match' do
    ...
    let(:expected_errors) do
      {
        data: { required: constraint.required?, type: DateTime },
