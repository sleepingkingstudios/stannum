...
require 'stannum/constraints/types/integer_type'

require 'support/examples/constraint_examples'

RSpec.describe Stannum::Constraints::Types::IntegerType do
  include Spec::Support::Examples::ConstraintExamples

  subject(:constraint) { described_class.new(**constructor_options) }

  let(:constructor_options) { {} }
  let(:expected_options)    { { expected_type: Integer, required: true } }
  ...
  describe '#expected_type' do
    include_examples 'should have reader', :expected_type, Integer
  end
  ...
  describe '#match' do
    ...
    let(:expected_errors) do
      {
        data: { required: constraint.required?, type: Integer },
