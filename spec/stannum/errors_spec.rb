...
RSpec.describe Stannum::Errors do
  ...
  describe '#with_messages' do
    shared_examples 'should generate error messages' do
      ...
      it 'should generate the error messages' do
        expect(errors.with_messages.to_a)
      ...
      describe 'with strategy: value' do
        ...
        it 'should generate the error messages' do
          expect(errors.with_messages(strategy: strategy).to_a)
            .to contain_exactly(*errors_with_messages)
        end
      end
    end
    ...
    it 'should create a copy of the errors' do
      expect { errors.with_messages.add(:some_error) }
        .not_to change(errors, :size)
    end
